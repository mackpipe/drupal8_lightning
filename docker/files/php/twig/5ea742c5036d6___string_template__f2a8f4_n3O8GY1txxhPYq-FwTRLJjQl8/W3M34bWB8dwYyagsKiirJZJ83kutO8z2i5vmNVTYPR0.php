...
/* __string_template__f2a8f429b0f659c950638b7e04b4d0b88251972cb98bed5138e99e0ed40dff15 */
class __TwigTemplate_f7f9fa7798644cb3ecd13c75589f14327b4983d9b18bbc5751b15f0c361eb5d4 extends \Twig\Template
{
...
\t\t<div class=\"texto\">";
        // line 7
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["field_tipo_servicio_texto_corto"] ?? null)), "html", null, true);
        echo "</div>
\t\t<div class=\"boton\">";
        // line 8
...
\t</div>
    ...
    {
        return "__string_template__f2a8f429b0f659c950638b7e04b4d0b88251972cb98bed5138e99e0ed40dff15";
    }
...
\t</div>
\t<div class=\"info\">
\t\t<div class=\"texto\">{{ field_tipo_servicio_texto_corto }}</div>
\t\t<div class=\"boton\">{{ field_tipo_servicio_url }} </div>
\t</div>
</div>", "__string_template__f2a8f429b0f659c950638b7e04b4d0b88251972cb98bed5138e99e0ed40dff15", "");
    }
}
